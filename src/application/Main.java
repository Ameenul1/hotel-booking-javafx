...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        stg = primaryStage;
        Parent login = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("../fxml_files/login.fxml"))); //loading the scene design from fxml file created by scene builder
        Scene loginScene = new Scene(login,800,550); //creating new scene and setting window size
        loginScene.getStylesheets().add(Objects.requireNonNull(getClass().getResource("../css files/authScene.css")).toExternalForm()); //linking css file
