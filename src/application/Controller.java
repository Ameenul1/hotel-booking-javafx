...
public class Controller {
    ...
    public void setLoginScreen() throws IOException {
        Parent login = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("../fxml_files/login.fxml")));
        Scene loginScene = new Scene(login, 800, 550);
        loginScene.getStylesheets().add(Objects.requireNonNull(getClass().getResource("../css files/authScene.css")).toExternalForm());
    ...
    public void setSignUpScreen() throws IOException {
        //register
        Parent register = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("../fxml_files/register.fxml")));
        Scene registerScene = new Scene(register, 800, 550);
        registerScene.getStylesheets().add(Objects.requireNonNull(getClass().getResource("../css files/authScene.css")).toExternalForm());
        Main.stg.setResizable(false);
    ...
    public void setUserHomeScreen() throws IOException {
        Parent userHome = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("../fxml_files/userHome.fxml")));
        Scene userHomeScene = new Scene(userHome, 800, 550);
        userHomeScene.getStylesheets().add(Objects.requireNonNull(getClass().getResource("../css files/homeScene.css")).toExternalForm());
        Main.stg.setResizable(false);
    ...
    public void setAccountDetailsScreen() throws IOException{
        Parent account = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("../fxml_files/accountDetails.fxml")));
        Scene accountScene = new Scene(account, 800, 550);
        accountScene.getStylesheets().add(Objects.requireNonNull(getClass().getResource("../css files/homeScene.css")).toExternalForm());
        Main.stg.setResizable(false);
        Main.stg.setTitle("Hotel booking-"+activeUser.userName);
    ...
    public void setSearchScreen() throws IOException {
        ...
        Parent account = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("../fxml_files/hotelsearch.fxml")));
        Scene accountScene = new Scene(account, 800, 550);
        accountScene.getStylesheets().add(Objects.requireNonNull(getClass().getResource("../css files/homeScene.css")).toExternalForm());
        Main.stg.setResizable(false);
        Main.stg.setTitle("Hotel booking-"+activeUser.userName);
    ...
    public void setBookings() throws IOException {
        Parent bookings = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("../fxml_files/bookings.fxml")));

        Scene bookingScene = new Scene(bookings, 800, 550);
        bookingScene.getStylesheets().add(Objects.requireNonNull(getClass().getResource("../css files/homeScene.css")).toExternalForm());
        Main.stg.setResizable(false);
